<x-guest-layout
    ...
    metaDescription="Haben Sie Ihr Passwort vergessen? Hier können Sie es sicher zurücksetzen, um wieder Zugriff auf Digitalpackt zu erhalten."
>
            ...
            <div class="bg-white/70 backdrop-blur-2xl rounded-[2.5rem] shadow-[0_20px_50px_rgba(8,_112,_184,_0.07)] p-8 sm:p-10 space-y-6 border border-white/60">
                ...
                <form method="POST" action="{{ route('password.email') }}" class="space-y-5">
                    ...
                    <div class="space-y-1.5">
                        <label for="email" class="text-xs font-bold text-slate-500 uppercase tracking-wider ml-1">
                            E-Mail Adresse
                        </label>
                    ...
                    <button type="submit"
                        class="w-full py-4 px-6 text-white font-bold text-base rounded-2xl bg-slate-900 hover:bg-blue-600 hover:shadow-lg hover:shadow-blue-500/20 transition duration-300 flex items-center justify-center group">
                    ...
                    <div class="relative py-4">
                        ...
                        <div class="relative flex justify-center text-xs uppercase tracking-tighter">
                            <span class="px-3 bg-white/0 text-slate-400 font-bold">
                    ...
                    <a href="{{ route('login') }}"
                       class="w-full py-3.5 px-6 border border-slate-200 text-slate-900 font-bold text-sm rounded-2xl bg-white hover:bg-slate-50 hover:border-slate-300 transition duration-300 flex items-center justify-center">
                        Zurück zum Login
                    </a>
                </form>
            </div>
