<x-guest-layout robots="noindex, nofollow"title="Passwort vergessen" metaDescription="Haben Sie Ihr Passwort vergessen? Hier können Sie es sicher zurücksetzen, um wieder Zugriff auf Digitalpackt zu erhalten.">
                ...
                <form method="POST" action="{{ route('password.email') }}" class="space-y-5">
                    ...
                    <div class="relative py-4">
                        ...
                        <div class="relative flex justify-center text-xs uppercase tracking-tighter">
                            <span class="px-3 bg-white/0 text-slate-400 font-bold">Passwort wieder eingefallen?</span>
                        </div>
                    </div>

                    <a href="{{ route('login') }}" class="w-full py-3.5 px-6 border border-slate-200 text-slate-900 font-bold text-sm rounded-2xl bg-white hover:bg-slate-50 hover:border-slate-300 transition duration-300 flex items-center justify-center">
                        Zurück zum Login
                    </a>
                </form>
            </div>
