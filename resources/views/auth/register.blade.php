<x-guest-layout robots="noindex, nofollow" title="Konto erstellen" metaDescription="Erstellen Sie ein kostenloses Konto bei Digitalpackt und nutzen Sie unsere praktischen Entwickler-Tools.">
        ...
        <div class="max-w-md w-full relative z-10">
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">
                    Neues Konto bei Digitalpackt erstellen
                </h1>
