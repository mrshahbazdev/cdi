...
<head>
    ...
    <style>
        ...
        /* Blob animation (non-layout affecting) */
        @keyframes blob {
...
<!-- Skip link (Accessibility BIG WIN) -->
<a href="#main-content"
...
<div class="min-h-screen flex flex-col relative overflow-hidden">
    ...
    <div aria-hidden="true" class="absolute top-0 right-0 -mt-20 -mr-20 w-96 h-96 bg-blue-100 rounded-full blur-3xl opacity-40 animate-blob"></div>
    <div aria-hidden="true" class="absolute bottom-0 left-0 -mb-20 -ml-20 w-96 h-96 bg-indigo-100 rounded-full blur-3xl opacity-40 animate-blob"></div>
    ...
    <footer role="contentinfo" class="bg-gray-900 border-t border-gray-800">
                    ...
                    <div class="flex gap-4 mt-6">
                        @if($settings?->linkedin_url)
                            <a href="{{ $settings->linkedin_url }}"
                               ...
                               aria-label="LinkedIn"
                               class="w-10 h-10 flex items-center justify-center rounded-lg bg-gray-800 text-gray-400 hover:text-white hover:bg-blue-700">
