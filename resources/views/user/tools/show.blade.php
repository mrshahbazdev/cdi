...
/*
|--------------------------------------------------------------------------
| SEO-Optimierung (Behebt Title & Meta Description Probleme)
|--------------------------------------------------------------------------
*/
$currentPage = request()->get('page');
$pageSuffix = ($currentPage && $currentPage > 1) ? " (S.$currentPage)" : "";

// Titel kurz halten für SEO-Pixel-Limit
$seoTitle = Str::limit($tool->name, 20) . " – Tool" . $pageSuffix;

// WICHTIG: Die Beschreibung MUSS einzigartig sein
$rawDescription = $tool->description ?? 'Professionelles SaaS Tool für Entwickler.';
$seoDescription = Str::limit(strip_tags($rawDescription), 130) . $pageSuffix;
...
{{-- ✅ 1. Überschreibt den Titel im Layout (@yield('title')) --}}
@section('title', $seoTitle)

{{-- ✅ 2. Übergibt die Beschreibung an das Layout-Attribut --}}
<x-app-layout :metaDescription="$seoDescription">

    {{-- ✅ 3. Sicherheit: Wir pushen die Meta-Tags zusätzlich in den Header --}}
    @push('meta')
                ...
                <div class="flex flex-col lg:flex-row gap-12 items-center lg:items-start">
                    ...
                    <div class="flex-1 text-center lg:text-left">
                        ...
                        <p class="text-xl text-gray-500 font-medium mb-10 max-w-4xl">
                            {{ $tool->description ?? 'Nutzen Sie diese Hochleistungs-Utility.' }}
                        </p>
